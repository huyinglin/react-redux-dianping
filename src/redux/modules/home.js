...
// selectors
export const getLikes = ({ home, entities }) =>
  home.likes.ids.map(id => entities.products[id]);

export const getDiscounts = ({ home, entities }) =>
  home.discounts.ids.map(id => entities.products[id]);

export const getPageCountOfLikes = ({ home }) =>
